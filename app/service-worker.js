const CACHE='tuinbooks-v60-8-29-basket-persistence-source-repair';
const VERSION='60.8.29-basket-persistence-source-repair';
const SHELL=[
  ...
  './vendor/supabase.js',
  './supabase-config.js',
  './app.js?v=60.8.29-basket-persistence-source-repair',
  ...
  './demo-showroom-v60417.js?v=60.8.24-demo-showroom-hydration-gate',
  ...
  './visit-controls-v60521.js?v=60.8.28-schedule-ui-stability-repair',
  './schedule-drag-mode-v6061.js?v=60.8.28-schedule-ui-stability-repair',
  './schedule-drag-basket-v6066.js?v=60.8.28-schedule-ui-stability-repair',
