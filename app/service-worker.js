const CACHE='tuinbooks-v60-8-27-schedule-interaction-source-repair';
const VERSION='60.8.28-schedule-ui-stability-repair';
const SHELL=[
  ...
  './vendor/supabase.js',
  './supabase-config.js',
  './app.js?v=60.8.22-demo-durable-flush-scope-fix',
