const CACHE='tuinbooks-v60-8-13-cancellation-history-billing';
const VERSION='60.8.13-cancellation-history-billing';
const SHELL=[
  ...
  './vendor/supabase.js',
  './supabase-config.js',
  './app.js?v=60.8.13-cancellation-history-billing',
